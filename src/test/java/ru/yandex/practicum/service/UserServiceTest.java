...
class UserServiceTest {
    ...
    @BeforeEach
    void setUp() {
        user = new User(1, "mail@mail.com", "kobra", "Stas", LocalDate.of(1983, 10, 3));
        user2 = new User(2, "m@m.ru", "shlang", "Vitalik", LocalDate.of(1988, 6, 13));
        wrongUser = new User(999, "", "", "", LocalDate.now());
    ...
    void givenNewEntityWithRightId_whenUseUpdateUserMethod_thenEntityMustBeReplacedWithNewGivenOne() {
        ...
        User newUser = new User(1, "fail@fail.ccc", "neKobra", "neStas", LocalDate.of(1995, 1, 12));
