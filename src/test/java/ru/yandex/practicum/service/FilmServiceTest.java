...
//        likeStorage = new LikeStorageImpl();
//        userStorage = new InMemoryUserStorage();
//        filmService = new FilmService();
//        userService = new UserService(userStorage);
//        film = new Film(1, "погоня", "описание погони", LocalDate.of(2001, 9, 13),
//                222, null, null);
//        film2 = new Film(2, "побег", "описание побега", LocalDate.of(2001, 9, 12),
//                444, null, null);
//        wrongFilm = new Film(999, "", "", LocalDate.of(1777, 7, 7),
//                -2000, null, null);
//    }
//
//    @Test
...
//        userService.addUser(new User(1, "s@s.s", "s", "s",
//                LocalDate.of(1990, 3, 4), null));
//        filmService.addFilm(film);
//        filmService.addFilm(film2);
